(function ($) {
    ...
    $(function () {
        ...
        if (!WebUploader.Uploader.support('flash') && WebUploader.browser.ie) {
            ...
            if (flashVersion) {
                (function (container) {
                    ...
                    const swf = 'Scripts/expressInstall.swf';
                    // insert flash object
        ...
        uploader = WebUploader.create({
            ...
            server: 'http://127.0.0.1:8838/chunk/upload',
            ...
            fileSizeLimit: 1000 * 1024 * 1024 * 5, //1G
            fileSingleSizeLimit: 1000 * 1024 * 1024 * 5  //1G
        });
        ...
        uploader.on('uploadSuccess', function (file, response) {
            if (response != null) {
                ...
                $.post("http://127.0.0.1:8838/chunk/merge", data);
            }
        });
